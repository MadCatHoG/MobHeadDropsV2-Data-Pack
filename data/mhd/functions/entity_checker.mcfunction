...
execute if entity @e[type=ocelot,nbt={CatType:0},tag=!mhd] run function mhd:set_loot_table
execute if entity @e[type=ocelot,nbt=!{CatType:0},tag=!mhd_tamed] run function mhd:set_loot_table
...
execute if entity @e[type=wither,tag=!mhd] run function mhd:set_loot_table
